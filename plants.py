...
class Cell:
    ...
    COLORS = {LEAF_5: (0,255,96), LEAF_4: (16,255,64), LEAF_3: (0,255,32), LEAF_2: (0,240,32), LEAF: (0,240,0), YOUNG: (64,192,16), YOUNG_2: (64,192,16), MATURE: (128,128,32), OLD: (192,64,48), DEAD: (160,64,64), SOLID: (48,48,48)}
